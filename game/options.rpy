...
# define config.name = _("너에게_물주는_법")
...
define build.name = "너에게_물주는_법"

## 배포판 디렉토리/파일 이름에 사용되는 ASCII 전용 이름. build.name에 한글이나
## 공백이 있어도 배포판이 정상적으로 만들어지도록 명시적으로 지정합니다.

define build.directory_name = "너에게_물주는_법"
...
define config.main_menu_music = "audio/title_music_1.mp3"
...
define config.save_directory = "visual_novel-1782466500"
